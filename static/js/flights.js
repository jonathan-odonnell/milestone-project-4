/* Sets start date and end date. Code is from https://gijgo.com/datepicker/configuration/minDate and 
https://gijgo.com/datepicker/configuration/maxDate */
let startDate = new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate() + 14);
let endDate = new Date(new Date().getFullYear() + 1, new Date().getMonth(), new Date().getDate() + 14);
