...
urlpatterns = [
    ...
    path('offers/filter/', views.filter_holidays, name='filter_offers'),
    ...
    path('destinations/<slug:destination>/filter/', views.filter_holidays, name='filter_destinations'),
    ...
    path('<slug:category>/filter/', views.filter_holidays, name='filter_categories'),
